...
import { conditionalValue, bucket, removeElementsFromArray } from "../../mgrui/lib/components/utils";
...
export default function ResourceCanvas(props: {
  ...
  const items = bucket<CanvasItem[]>([]);
  const background = bucket<Res | null>(null);
