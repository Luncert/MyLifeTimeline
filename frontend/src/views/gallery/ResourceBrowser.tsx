...
import { bucket, stampedBucket, names } from "../../mgrui/lib/components/utils";
...
export function ResourceBrowser(){
  ...
  const selectedTab = bucket<string>("imported");
  const openStorageBrowserModal = bucket(false);
  const importedFiles = stampedBucket(new Set<StorageFile>());
